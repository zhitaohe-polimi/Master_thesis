...
class KGAT_RecommenderWrapper(BaseRecommender, Incremental_Training_Early_Stopping, BaseTempFolder):
    ...
    def _compute_item_score(self, user_id_array, items_to_compute=None):
        ...
        if self.args.model_type in ['ripple']:
            u_batch_size = BATCH_SIZE
            i_batch_size = BATCH_SIZE // 20
        elif self.args.model_type in ['fm', 'nfm']:
            u_batch_size = BATCH_SIZE
    ...
    def _run_epoch(self, currentEpoch):
        ...
        n_batch = self.data_generator.n_train // self.args.batch_size + 1
        ...
        *********************************************************
        ...
        """
        if self.args.model_type in ['kgat']:

            n_A_batch = len(self.data_generator.all_h_list) // self.args.batch_size_kg + 1

            if self.args.use_kge is True:
