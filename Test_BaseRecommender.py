...
class MyTestCase(unittest.TestCase):
    ...
    def test_compute_item_score(self):
        ...
        recommender_class = # TODO ADD the class of the recommender you ported

        recommender_instance, URM_train, URM_test = get_data_and_rec_instance(recommender_class, Movielens100KReader)

        n_users, n_items = URM_train.shape

        recommender_instance.fit(epochs = 10)
    ...
    def test_save_and_load(self):
        ...
        recommender_instance_original.fit(epochs = 10)
        ...
        for user_id in range(n_users):
            ...
            item_scores_original_2 = recommender_instance_original._compute_item_score(user_id_array = [user_id],
                                                               items_to_compute = None)
            ...
            if not is_stochastic:
                ...
                print("Algorithm is stochastic, since scores will be different between runs the integrity of the loaded model cannot be verified based on it computing the same predictions")
                break
