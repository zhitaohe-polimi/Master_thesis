...
class FW_RATING_BPR_Cython(FW_RATING_RMSE_Python):


    def __init__(self, URM_train, ICM):

        super(FW_RATING_BPR_Cython, self).__init__(URM_train, ICM)
    ...
    def fit(self, epochs=30, logFile=None, URM_test=None, filterTopPop = False, minRatingsPerUser=1,
        ...
        from FW_Rating.Cython.FW_RATING_BPR_Cython_Epoch import FW_RATING_BPR_Cython_Epoch

        # Instantiate fast Cython implementation
        self.cythonEpoch = FW_RATING_BPR_Cython_Epoch(self.ICM,
                                                 self.URM_train,
                                                 self.weights,
                                                 self.S_denominator,
        ...
        super(FW_RATING_BPR_Cython, self).fit(epochs=epochs,
                                              log_file=logFile,
                                              URM_test=URM_test,
