    ...
    try:
        ...
        if recommender_class is PyTorchNewMF_BPR_Recommender:
            hyperparameters_range_dictionary = {
                ...
                "num_factors_u": Categorical([164]),  # Integer(1, 200), Categorical([188])
                "num_factors_i": Categorical([99,101]),  # Integer(1, 200), Categorical([1])
                "epochs": Categorical([1500]),
                "sgd_mode": Categorical(["adam"]),
                ...
                "learning_rate": Categorical([0.0017036914547573577]),
                # Real(low=1e-4, high=1e-1, prior='log-uniform'), Categorical([0.0014859247023756878])
                "l2_reg": Categorical([1.661021862062968e-07]),
                # Real(low=1e-7, high=1e-6, prior='log-uniform'), Categorical([1e-07])
            }
